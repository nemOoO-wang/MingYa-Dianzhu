...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [JPUSHService setupWithOption:launchOptions
                           appKey:@"c4093493584d45697eeb52ee"
                          channel:@"球哥"
                 apsForProduction:NO
...
//    NSString *advertisingId = [[[ASIdentifierManager sharedManager] advertisingIdentifier] UUIDString];
    ...
    BOOL hasShowAppIntro = [[NSUserDefaults standardUserDefaults] objectForKey:@"hasShowAppIntro"];
    if (!hasShowAppIntro) {
...
//    PreLoginViewController *con = (PreLoginViewController *)self.window.rootViewController;
//    [con shouldShowNotificationViewController];
    
    UIViewController *con2 = [self getPresentedViewController];
    UINavigationController *messageTabCon = [con2.storyboard instantiateViewControllerWithIdentifier:@"NotificationTab"];
    [con2 presentViewController:messageTabCon animated:YES completion:^{
        // complete
    }];
